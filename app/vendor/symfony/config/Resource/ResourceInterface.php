...
/**
 * ResourceInterface is the interface that must be implemented by all Resources classes.
 *
...
interface ResourceInterface
{
     ...
     * resource instances.
     *
     * @return string A string representation unique to the underlying Resources
     */
